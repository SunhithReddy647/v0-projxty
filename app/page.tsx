...
export default function Home() {
  ...
  const sections = ["Home", "About Us", "Services", "Our Pricing", "Clients Brands", "Careers", "Blog", "Contact Us"]

  const itDomains = [
    { name: "Web Development", description: "Build responsive and optimized websites using modern frameworks." },
    { name: "App Development", description: "Design and develop mobile apps with practical implementation." },
    { name: "Artificial Intelligence", description: "Work on smart algorithms and intelligent systems." },
    { name: "Machine Learning", description: "Apply ML models to solve real-world problems." },
    { name: "Data Science", description: "Analyze data and build predictive insights." },
    { name: "Cybersecurity", description: "Explore security practices, testing, and system protection." },
    { name: "Cloud Computing", description: "Deploy and manage cloud-based environments." },
    { name: "Software Development", description: "Learn clean coding and real-world app logic." },
    { name: "DevOps", description: "Automate deployment pipelines and CI/CD workflows." },
    { name: "Blockchain", description: "Develop and test decentralized applications." },
    { name: "Internet of Things (IoT)", description: "Integrate hardware and software for smart devices." },
    { name: "UI/UX Design", description: "Design engaging and user-focused digital interfaces." },
    { name: "Game Development", description: "Build interactive games using industry tools." },
    { name: "Database Management", description: "Manage data systems and ensure reliability." },
    { name: "Networking", description: "Work with communication systems and server management." },
  ]

  const nonItDomains = [
    { name: "Marketing", description: "Build strategies to promote digital products and services." },
    { name: "Digital Marketing", description: "Learn social campaigns, SEO, and performance tracking." },
    { name: "Finance", description: "Understand business metrics and financial models." },
    { name: "Accounting", description: "Manage ledgers, reports, and data-driven accuracy." },
    { name: "Human Resources", description: "Contribute to team management and talent acquisition." },
    { name: "Operations", description: "Assist with workflow optimization and coordination." },
    { name: "Business Development", description: "Identify opportunities and support partnerships." },
    { name: "Sales", description: "Learn effective communication and conversion strategies." },
    { name: "Entrepreneurship", description: "Build startup-oriented projects and case studies." },
    { name: "Content Writing", description: "Craft blogs, website copy, and creative writing." },
    { name: "Graphic Design", description: "Create visuals and branding assets for digital platforms." },
  ]
        ...
        <div className="relative z-10 pt-16">
          ...
          <section className="min-h-screen flex flex-col justify-center px-6 py-12">
            ...
            <div className="mt-8 flex flex-col gap-3">
              <Link href="/start-project" className="rounded-full bg-gradient-to-r from-primary to-accent px-6 py-3 text-sm font-semibold text-background text-center">
                Start Your Project
              </Link>
              <button className="rounded-full border-2 border-foreground/30 px-6 py-3 text-sm font-semibold text-foreground">
                View Our Work →
              </button>
            </div>
          ...
          <section className="min-h-screen px-6 py-16">
            ...
            <div className="space-y-4 mb-6">
              ...
              <div className="rounded-lg border-2 border-primary/40 bg-gradient-to-br from-primary/15 via-accent/15 to-primary/20 p-6 relative">
                ...
                <Link href="/start-project" className="w-full rounded-lg bg-gradient-to-r from-primary to-accent px-6 py-3 text-sm font-semibold text-background text-center">
                  Get Started
                </Link>
              </div>
          ...
          {/* Careers Section - Simplified for mobile */}
          <section className="min-h-screen px-6 py-16">
            <div className="text-center mb-8">
              <h1 className="font-monument text-4xl font-bold text-foreground mb-4">Join Our Team</h1>
              <p className="text-sm text-foreground/70">AICTE-approved internships and full-time opportunities</p>
            </div>

            <div className="flex gap-3 mb-8 justify-center">
              <button
                onClick={() => setCareersTab("fulltime")}
              ...
              <button
                onClick={() => setCareersTab("internships")}
                className={`px-6 py-3 rounded-full text-sm font-semibold transition-all ${
                  careersTab === "internships"
                    ? "bg-gradient-to-r from-primary to-accent text-background"
                    : "bg-foreground/5 text-foreground/60"
                }`}
              >
            ...
            {!careersTab && (
              <div className="text-center py-16">
                <p className="text-foreground/60">Select a category to view opportunities</p>
              </div>
            )}

            {careersTab === "fulltime" && (
              <div className="text-center py-16">
                <h2 className="text-2xl font-semibold text-foreground mb-4">Full-Time Positions</h2>
                <p className="text-sm text-foreground/60 mb-6">Check back soon for open positions.</p>
                <button className="rounded-full bg-foreground/10 px-6 py-3 text-sm font-semibold text-foreground">
                  Get Notified
                </button>
              </div>
            )}
            ...
            {careersTab === "internships" && (
              <div className="space-y-8">
                <div>
                  <h2 className="font-monument text-2xl font-bold text-foreground mb-4">IT Domains</h2>
                  <div className="space-y-3">
                    {itDomains.slice(0, 5).map((domain, idx) => (
                      <div key={idx} className="rounded-lg border-2 border-foreground/20 bg-foreground/5 p-4">
                        <div className="flex items-start justify-between mb-2">
                          <h3 className="font-sans text-base font-bold text-foreground">{domain.name}</h3>
                          <span className="text-xs font-bold text-primary uppercase">AICTE</span>
                        </div>
                        <p className="text-xs text-foreground/70 mb-3">{domain.description}</p>
                        <a
                          href="https://forms.gle/pZ5quDYmozAHk6AC6"
                          target="_blank"
                          rel="noopener noreferrer"
                          className="block w-full rounded-lg bg-gradient-to-r from-primary to-accent px-4 py-2.5 font-sans text-sm font-semibold text-background hover:shadow-lg hover:shadow-primary/30 hover:scale-[1.02] active:scale-[0.98] transition-all duration-200 text-center"
                        >
                          Apply Now
                        </a>
                      </div>
                ...
                <div>
                  <h2 className="font-monument text-2xl font-bold text-foreground mb-4">Non-IT Domains</h2>
                  <div className="space-y-3">
                    {nonItDomains.slice(0, 5).map((domain, idx) => (
                      <div key={idx} className="rounded-lg border-2 border-foreground/20 bg-foreground/5 p-4">
                        <div className="flex items-start justify-between mb-2">
                          <h3 className="font-sans text-base font-bold text-foreground">{domain.name}</h3>
                          <span className="text-xs font-bold text-primary uppercase">AICTE</span>
                        ...
                        <a
                          ...
                          target="_blank"
                          rel="noopener noreferrer"
                          className="block w-full rounded-lg bg-gradient-to-r from-primary to-accent px-4 py-2.5 font-sans text-sm font-semibold text-background hover:shadow-lg hover:shadow-accent/30 hover:scale-[1.02] active:scale-[0.98] transition-all duration-200 text-center"
                        >
                          Apply Now
                        </a>
                      </div>
            ...
            <div className="space-y-4 mb-8">
              ...
              <div className="flex items-center gap-3">
                ...
                <div>
                  ...
                  <a href="tel:+919876543210" className="text-sm font-medium text-foreground">
                    +91 98765 43210
                  </a>
                </div>
              </div>
      ...
      >
        ...
        >
          <div className="max-w-6xl mx-auto w-full">
            ...
            <div className="mt-8 sm:mt-10 flex flex-col gap-3 sm:gap-4 md:flex-row md:items-center md:gap-6">
              <Link href="/start-project" className="rounded-full bg-gradient-to-r from-primary to-accent px-6 sm:px-8 py-3 sm:py-4 font-sans text-sm sm:text-base font-semibold text-background transition-all hover:shadow-lg hover:shadow-primary/25 hover:scale-105 active:scale-95 text-center">
                Start Your Project
              </Link>
              <button className="group rounded-full border-2 border-foreground/30 px-6 sm:px-8 py-3 sm:py-4 font-sans text-sm sm:text-base font-semibold text-foreground transition-all hover:border-foreground/60 hover:bg-foreground/5">
                View Our Work
          ...
          <div className="flex-1 flex flex-col h-full max-w-7xl mx-auto w-full">
            ...
            <div className="flex-1 grid grid-cols-1 lg:grid-cols-3 gap-4 sm:gap-5 mb-5 sm:mb-6">
              ...
              >
                ...
                <Link href="/start-project" className="w-full rounded-lg bg-gradient-to-r from-primary to-accent px-6 py-3 font-sans text-sm font-semibold text-background text-center">
                  Get Started
                </Link>
              </div>
        ...
        >
          <div className="max-w-7xl mx-auto w-full pb-16 sm:pb-24 pt-16 sm:pt-20">
            {/* Hero Section */}
            <div className="text-center mb-10 sm:mb-14 animate-in fade-in slide-in-from-top-2 duration-700">
              <h1 className="font-monument text-5xl sm:text-6xl lg:text-7xl font-bold text-foreground mb-4 sm:mb-6">
                Join Our Team
              </h1>
            ...
            <div className="flex items-center justify-center gap-3 sm:gap-4 mb-10 sm:mb-12">
              <button
                onClick={() => setCareersTab("fulltime")}
                className={`px-6 sm:px-8 lg:px-10 py-3 sm:py-4 rounded-full font-sans text-sm sm:text-base font-semibold transition-all duration-300 ${
                  careersTab === "fulltime"
            ...
            {!careersTab && (
              <div className="text-center py-16 sm:py-24 animate-in fade-in duration-500">
                <div className="inline-block p-4 rounded-full bg-foreground/5 mb-6">
                  <svg className="h-16 w-16 text-foreground/40" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path
                      strokeLinecap="round"
                      strokeLinejoin="round"
                      strokeWidth={1.5}
                ...
                <h2 className="font-monument text-2xl sm:text-3xl lg:text-4xl font-semibold text-foreground mb-3">
                  Select a Category
                </h2>
                <p className="text-base text-foreground/60 max-w-md mx-auto">
                  Choose Full-Time or Internships above to explore our career opportunities.
                </p>
              </div>
            )}
            ...
            {careersTab === "fulltime" && (
              <div className="animate-in fade-in slide-in-from-top-2 duration-500">
                <div className="text-center py-16 sm:py-24">
                  <h2 className="font-sans text-2xl sm:text-3xl lg:text-4xl font-semibold text-foreground mb-4">
                    Full-Time Positions
                  </h2>
                  <p className="text-base sm:text-lg text-foreground/60 mb-8 max-w-2xl mx-auto">
                    We're always looking for talented individuals to join our team. Check back soon for open positions.
                  </p>
                  <button className="rounded-full bg-foreground/10 px-8 py-4 font-sans text-sm font-semibold text-foreground hover:bg-foreground/20 transition-all">
                    Get Notified
                  </button>
                </div>
              </div>
            ...
            {careersTab === "internships" && (
              <div className="animate-in fade-in slide-in-from-top-2 duration-500 space-y-10 sm:space-y-12">
                {/* IT Domains Section */}
                <div>
                  <h2 className="font-monument text-2xl sm:text-3xl lg:text-4xl font-bold text-foreground mb-6 sm:mb-8 text-center">
                    IT Domains
                  </h2>
                  <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4 sm:gap-5 lg:gap-6">
                    {itDomains.map((domain, idx) => (
                      <div
                        key={idx}
                        className="group relative rounded-2xl border-2 border-foreground/20 bg-foreground/5 p-5 sm:p-6 hover:border-primary/40 hover:bg-foreground/8 hover:shadow-lg hover:shadow-primary/10 hover:scale-[1.02] transition-all duration-300"
                      >
                        {/* AICTE Badge */}
                        <div className="absolute top-3 right-3 sm:top-4 sm:right-4">
                          <div className="flex items-center gap-1.5 rounded-full bg-gradient-to-r from-primary/20 to-accent/20 border border-primary/30 px-2.5 py-1 backdrop-blur-sm">
                            ...
                            <span className="text-[10px] font-bold text-foreground uppercase">{""}</span>
                          </div>
                        </div>

                        <div className="pr-16 sm:pr-20">
                          <h3 className="font-sans text-lg sm:text-xl font-bold text-foreground mb-2 group-hover:text-primary transition-colors">
                            {domain.name}
                          </h3>
                ...
                <div>
                  ...
                  <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4 sm:gap-5 lg:gap-6">
                    {nonItDomains.map((domain, idx) => (
                      <div
                        key={idx}
                        className="group relative rounded-2xl border-2 border-foreground/20 bg-foreground/5 p-5 sm:p-6 hover:border-accent/40 hover:bg-foreground/8 hover:shadow-lg hover:shadow-accent/10 hover:scale-[1.02] transition-all duration-300"
                      >
                        {/* AICTE Badge */}
                        <div className="absolute top-3 right-3 sm:top-4 sm:right-4">
                          <div className="flex items-center gap-1.5 rounded-full bg-gradient-to-r from-primary/20 to-accent/20 border border-primary/30 px-2.5 py-1 backdrop-blur-sm">
                        ...
                        <div className="pr-16 sm:pr-20">
                          <h3 className="font-sans text-lg sm:text-xl font-bold text-foreground mb-2 group-hover:text-accent transition-colors">
                            {domain.name}
                          </h3>
                          <p className="text-xs sm:text-sm text-foreground/70 leading-relaxed mb-5">
                            {domain.description}
