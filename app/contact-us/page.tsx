...
export default function ContactUsPage() {
  return (
    <main className="relative min-h-screen w-full bg-background">
      ...
      <div className="relative z-10 flex flex-col items-center justify-center min-h-screen px-6 md:px-12 pt-32 pb-20">
        <div className="w-full max-w-4xl">
          <h1 className="text-7xl md:text-9xl font-bold text-center text-foreground mb-16">Contact Us</h1>
          <div className="w-full h-96 md:h-screen rounded-lg overflow-hidden border border-white/10">
            <iframe 
              src='https://my.spline.design/genkubgreetingrobot-guZ1GlftWPM8QmWg7NhOI0Jk/' 
              frameBorder='0' 
              width='100%' 
              height='100%'
